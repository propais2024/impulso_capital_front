...
export default function EncuestaSalidaTab({ id }) {
  ...
  const [tableName] = useState('pi_encuesta_salida'); // Nombre de la tabla pi_encuesta_salida
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (recordId) {
        ...
        alert('Encuesta de salida actualizada exitosamente');
      } else {
        ...
        alert('Encuesta de salida guardada exitosamente');
      }
    } catch (error) {
